...
const style: Record<Themes, string> = {
    ...
    button: "rounded-xl px-4 active:translate-y-[1px] bg-my-neutral-100 hover:bg-my-neutral-200 focus-visible:bg-my-neutral-200 outline-none focus-visible:ring-2 focus-visible:ring-blue-500 h-10 shrink-0 flex items-center justify-center font-normal",
