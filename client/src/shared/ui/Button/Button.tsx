...
const cls: Record<Themes, string> = {
    regular:
        "text-inherit rounded-xl px-4 [&>*]:stroke-2 active:translate-y-[1px] bg-my-neutral-100 hover:bg-my-neutral-200 focus-visible:bg-my-neutral-200 text-sm sm:text-base",
    regularNav:
        "text-inherit rounded-xl px-4 [&>*]:stroke-2 active:translate-y-[1px] bg-my-white hover:bg-my-neutral-100 focus-visible:bg-my-neutral-100 text-sm sm:text-base",
    regularIcon:
    ...
    blue: "text-neutral-50 rounded-xl px-4 [&>*]:stroke-2 active:translate-y-[1px] bg-blue-500 justify-center hover:bg-blue-600 focus-visible:bg-blue-600 focus-visible:ring-my-neutral-800 text-sm sm:text-base",
    category:
    ...
    clean: "text-inherit rounded-xl px-4 [&>*]:stroke-2 active:translate-y-[1px] bg-transparent hover:bg-my-neutral-100 focus-visible:bg-my-neutral-100 justify-center text-sm sm:text-base",
    danger: "text-inherit rounded-xl px-4 [&>*]:stroke-2 active:translate-y-[1px] bg-my-red-200 hover:bg-my-red-300 focus-visible:bg-my-red-300 text-neutral-50 text-sm sm:text-base",
    success:
        "text-inherit rounded-xl px-4 [&>*]:stroke-2 active:translate-y-[1px] bg-my-green-500 hover:bg-my-green-600 focus-visible:bg-my-green-600 text-neutral-50 text-sm sm:text-base",
    ...
    return (
        <button
            ...
            className={classNames(
                "outline-none focus-visible:ring-2 focus-visible:ring-blue-500 flex items-center justify-between h-10 text-start shrink-0 ring-offset-0 relative",
                {
                    [activeCls]: active,
